...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://kuliner.yuk-kunjungi.com/abahmartabak");
    ...
    public void ClickLokasi (View view){
        ...
        redirectActivity(this,AlamatActivity.class);
    }


    public void ClickTestimoni (View view){
        //Redirect activity ke Testimoni
        redirectActivity(this,KataMerekaActivity.class);
    }

    public void ClickOwner (View view){
        //Redirect activity ke Owner
        redirectActivity(this,OwnerActivity.class);
    }
    ...
    public void ClickRate (View view){
        ...
        redirectActivity(this,RateActivity.class);
    }
