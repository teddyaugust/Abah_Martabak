...
public class  KataMerekaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kata_mereka);

        //buka webnya
        webView = (WebView) findViewById(R.id.katamereka_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("http://kuliner.yuk-kunjungi.com/abahmartabak/testimoni/");
